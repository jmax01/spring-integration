...
public class WebSocketParserTests {
    ...
    public void testDefaultInboundChannelAdapterAndServerContainer() {
        ...
        HandshakeInterceptor[] interceptors = TestUtils.getPropertyValue(this.serverWebSocketContainer, "interceptors",
        ...
        WebSocketHandlerDecoratorFactory[] decoratorFactories = TestUtils.getPropertyValue(
                this.serverWebSocketContainer, "decoratorFactories", WebSocketHandlerDecoratorFactory[].class);
        ...
        TransportHandlingSockJsService sockJsService = TestUtils.getPropertyValue(mappedHandler, "sockJsService",
                TransportHandlingSockJsService.class);
        ...
        assertThat(TestUtils.getPropertyValue(this.defaultInboundAdapter, "payloadType", AtomicReference.class)
        ...
        assertThat(TestUtils.getPropertyValue(subProtocolHandlerRegistry, "protocolHandlers", Map.class)
            .isEmpty()).isTrue();
    }
    ...
    public void testCustomInboundChannelAdapterAndClientContainer() throws URISyntaxException {
        ...
        assertThat(TestUtils.getPropertyValue(this.customInboundAdapter, "payloadType", AtomicReference.class)
        ...
        SubProtocolHandlerRegistry subProtocolHandlerRegistry = TestUtils.getPropertyValue(this.customInboundAdapter,
                "subProtocolHandlerRegistry", SubProtocolHandlerRegistry.class);
        assertThat(TestUtils.getPropertyValue(subProtocolHandlerRegistry, "defaultProtocolHandler"))
            .isSameAs(this.stompSubProtocolHandler);
        ...
        assertThat(TestUtils.getPropertyValue(this.simpleClientWebSocketContainer, "connectionManager.autoStartup",
                Boolean.class)).isFalse();
        assertThat(
                TestUtils.getPropertyValue(this.simpleClientWebSocketContainer, "headers", WebSocketHttpHeaders.class)
                    .isEmpty()).isTrue();
    }
