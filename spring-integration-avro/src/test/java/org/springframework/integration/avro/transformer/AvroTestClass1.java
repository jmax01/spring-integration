...
public class AvroTestClass1 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static org.springframework.integration.avro.transformer.AvroTestClass1.Builder newBuilder() {
    return new org.springframework.integration.avro.transformer.AvroTestClass1.Builder();
  }
   ...
   * @return A new AvroTestClass1 RecordBuilder
   */
  public static org.springframework.integration.avro.transformer.AvroTestClass1.Builder newBuilder(org.springframework.integration.avro.transformer.AvroTestClass1.Builder other) {
    return new org.springframework.integration.avro.transformer.AvroTestClass1.Builder(other);
  }
   ...
   * @return A new AvroTestClass1 RecordBuilder
   */
  public static org.springframework.integration.avro.transformer.AvroTestClass1.Builder newBuilder(org.springframework.integration.avro.transformer.AvroTestClass1 other) {
    return new org.springframework.integration.avro.transformer.AvroTestClass1.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroTestClass1>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.springframework.integration.avro.transformer.AvroTestClass1.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.springframework.integration.avro.transformer.AvroTestClass1 other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.bar)) {
        this.bar = data().deepCopy(fields()[0].schema(), other.bar);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.springframework.integration.avro.transformer.AvroTestClass1.Builder setBar(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.springframework.integration.avro.transformer.AvroTestClass1.Builder clearBar() {
      bar = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.springframework.integration.avro.transformer.AvroTestClass1.Builder setQux(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.springframework.integration.avro.transformer.AvroTestClass1.Builder clearQux() {
      qux = null;
